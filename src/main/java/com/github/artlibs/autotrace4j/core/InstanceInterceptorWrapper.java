...
public class InstanceInterceptorWrapper extends AbstractDelegateWrapper<Object> {
    private static final Map<AbstractInstance, InstanceInterceptorWrapper>
            Cache = new ConcurrentHashMap<>();

    public InstanceInterceptorWrapper(AbstractInstance enhancer) throws Exception {
        super(enhancer);
    }

    public static InstanceInterceptorWrapper wrap(AbstractInstance enhancer) throws Exception {
