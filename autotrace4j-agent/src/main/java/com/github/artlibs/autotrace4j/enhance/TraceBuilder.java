...
public final class TraceBuilder {
     ...
     */
    public void on(Instrumentation instrument, String[] args) throws IOException, InstantiationException,
            IllegalAccessException, ClassNotFoundException {
        AgentBuilder agentBuilder = this.getAgentBuilder(args);
     ...
     * @throws IllegalAccessException -
     */
    private AgentBuilder getAgentBuilder(String[] args) throws ClassNotFoundException,
        ...
        return new AgentBuilder.Default()
                ...
                .with(AgentBuilder.RedefinitionStrategy.RETRANSFORMATION).with(new AutoListener(args));
    }
    ...
    private static void processPackagePrefix(String enhancePackagePrefixes) {
        for (String prefix : enhancePackagePrefixes.split(TypePools.COMMA)) {
